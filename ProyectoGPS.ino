...
//-----------------------------------------------------------------------------------
#define FIREBASE_HOST "proyecto-gps-d4cb3-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "0bloeGMvsckqPhjzWebl0ZDkthk7oejwiFNBsuM35BrmKW"
#define WIFI_SSID "Net"
#define WIFI_PASSWORD "ldub3365"
//-----------------------------------------------------------------------------------
